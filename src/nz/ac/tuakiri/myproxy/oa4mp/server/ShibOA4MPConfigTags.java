...
public class ShibOA4MPConfigTags {
	...
	public static final String SHIBBOLETH_USERNAME_TRANSFORMER_RETURN_DN_AS_USERNAME = "returnDnAsUsername"; // Use the first certificate's DN as the username that is returned to the OAuth client (formatted in 'Globus' format, i.e. with '/' as separator)
}
